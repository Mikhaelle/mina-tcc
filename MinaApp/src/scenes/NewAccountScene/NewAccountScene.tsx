...
import {FormText, View, FormTextInput,BR, LoginButton,FormView, ElementView, LoginText} from './NewAccountScene.css'
      ...
      <View>
          <ElementView>
              ...
              <FormText>Confirmar Senha</FormText>
                  <BR/>
                  <FormTextInput onChangeText={(text) =>{equalPassword(text)}} value={confirmPassword} secureTextEntry={true}/>
                  {!checkEqualPassword && <FormText>Senhas não coincidem</FormText>}
              </FormView>
              <LoginButton onPress={() => {createAccount(userEmail,userPassword)}}><LoginText>Criar conta</LoginText></LoginButton>
            </ElementView>
        </View>
  );
};
