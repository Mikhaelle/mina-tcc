...
\lq\lq Fig. \ref{fig03}\rq\rq\ quando no meio de uma frase ou como 
\lq\lq Figura \ref{fig03}\rq\rq\ quando no início da mesma. Referencias 
implícitas a uma dada figura devem ser feitas entre parênteses como 
(Fig. \ref{fig03}). Para referências a mais de uma figura as mesmas regras 
...
\begin{itemize}
	...
	mostrados na Fig. \ref{fig03}, que ...\rq\rq
	\item \lq\lq A Figura \ref{fig03} apresenta os resultados obtidos, onde 
	...
	(Fig. \ref{fig03}), comprovando ...\rq\rq
\end{itemize}
